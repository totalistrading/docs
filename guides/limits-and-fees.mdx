...
icon: 'scale-balanced'
description: 'Every constraint and fee on Totalis: legs per bet, bet range, payout odds, timing windows, rate limits, and how the two fees are calculated.'
---
...
| --- | --- | --- |
| [Legs](/guides/glossary#the-noun-stack) per bet | 1 to 5 | [Create quote request](/api-reference/quote-service/create) |
