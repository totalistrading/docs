...
- 1 to 5 legs, 1 to 1000 USDC per bet, payout odds of at least 1.0001.
...
| --- | --- | --- |
| [Legs](/guides/glossary#the-noun-stack) per parlay | 1 to 5 | [Create quote request](/api-reference/quote-service/create) |
| Bet amount | 1 to 1000 USDC | Create quote request |
| Payout odds | At least 1.0001 | [Submit quote](/api-reference/quote-service-mm/submit-quote) |
