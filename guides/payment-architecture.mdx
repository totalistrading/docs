...
description: 'Totalis on-chain payment architecture — Solana escrow PDAs, Privy TEE wallet signing, and gas-sponsored transactions'
---
...
![Totalis on-chain payment flow diagram showing Solana escrow interactions between User, Parlay Escrow PDA, Market Maker, and Settlement Oracle](/parlay_escrow_architecture.png)
