...
<div className="dg-scroll">
  <img className="block dark:hidden" src="/images/diagrams/early-cashout-light.svg" alt="The two ways a cashout auction resolves, and what each one notifies" />
  <img className="hidden dark:block" src="/images/diagrams/early-cashout-dark.svg" alt="The two ways a cashout auction resolves, and what each one notifies" />
</div>
