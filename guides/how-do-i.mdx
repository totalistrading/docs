...
then commit the quote you want. Funds move only at `confirmed`.
...
Open a cashout request on an `executed` position, watch the stream for the best all-in price, and
