...
icon: 'gavel'
description: 'Bidding on parlay exits as a market maker: one broadcast auction, one all-in price, and the two outcomes that are not notified the same way.'
---

When a user leaves a parlay early, Totalis opens a short auction on that position and pushes it to
every market maker on the stream you already consume. You reply with one number. The highest live
bid wins. This page is for makers bidding on those auctions. The bettor's side is on
[Early cashout](/guides/early-cashout).

## At a glance

- A user can leave a live parlay early. Totalis opens an auction of about 10 seconds and broadcasts it to every maker.
