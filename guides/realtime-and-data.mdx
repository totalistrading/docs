...
| [Webhooks](/guides/webhooks) | **Post-trade events, durable** — most of the same lifecycle moments as HMAC-signed POSTs with retries and replay | Server systems of record that must never miss an event |
