...
| [Webhooks](/guides/webhooks) | **Posttrade events, durable** — the same lifecycle moments as HMAC signed POSTs with retries and replay | Server systems of record that must never miss an event |
...
Both deliver posttrade lifecycle events. They differ in the delivery guarantee:
