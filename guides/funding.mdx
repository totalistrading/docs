...
You fund your account with USDC in your Solana wallet. In the app you can buy USDC by card or Apple Pay, bridge from other supported chains, or send native Solana USDC from any wallet or exchange. Whichever route you take, the balance lands as USDC in your wallet. Placing a parlay pulls your stake into the vault automatically, so there's no separate deposit step.
...
| Bridge from another chain | In the app | A few minutes | From the chains offered in the app; delivers native Solana USDC |
