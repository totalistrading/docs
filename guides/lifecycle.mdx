...
<Steps>
  ...
  <Step title="Market Makers Submit Draft Quotes">
    Market makers poll [List Quote Requests](/api-reference/mm/list-quote-requests) or subscribe to the `quote_requests:open` WebSocket channel and submit draft quotes with their payout odds.
