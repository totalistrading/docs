...
| Check invalid leg combinations | `exclusion_keys` on [`GET /v1/markets/list`](/api-reference/markets/list-flat): two markets can share a parlay only if their arrays don't intersect |
