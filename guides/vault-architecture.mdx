...
Totalis is **noncustodial**. Your funds sit in an on chain Solana vault that the protocol's program controls — not in a Totalis held account. You enable trading once by delegating signing permission, and from then on placing, settling, and closing parlays happens without you signing each transaction by hand.
...
To trade, you grant Totalis permission to sign on your behalf inside that enclave (a one time consent in the app — see [Enable trading](/guides/funding#enable-trading-first)). This is **semicustodial**: you explicitly grant the permission and can revoke it at any time. Totalis can sign your trades, but never holds or can move your key.
