...
<div className="dg-scroll">
  <img className="block dark:hidden" src="/images/diagrams/websocket-light.svg" alt="The WebSocket handshake: connect, authenticate, subscribe, receive events, keep alive" />
  <img className="hidden dark:block" src="/images/diagrams/websocket-dark.svg" alt="The WebSocket handshake: connect, authenticate, subscribe, receive events, keep alive" />
</div>
