...
Totalis turns individual prediction-market bets into custom parlays. Pick 2–5 outcomes across Kalshi, Polymarket, and other venues, combine them into one leveraged position, and market makers compete to price it. Trades settle on Solana.
...
<Steps>
  ...
  <Step title="Get competitive quotes">
    Market makers compete over the Totalis request-for-quote (RFQ) system to offer the best payout odds.
  </Step>
  <Step title="Trade and settle">
    Accept a quote. Your stake and the maker's collateral lock in on-chain Solana vaults, and the position settles automatically when the markets resolve.
  </Step>
</Steps>
