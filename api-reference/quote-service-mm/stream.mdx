...
<RequestExample>
```bash curl
curl -N https://quote-service.totalis.trade/v1/mm/quote-requests/stream \
  -H "X-API-Key: $API_KEY" \
...
const es = new EventSource(
  'https://quote-service.totalis.trade/v1/mm/quote-requests/stream',
...
url = 'https://quote-service.totalis.trade/v1/mm/quote-requests/stream'
headers = {
    'X-API-Key': API_KEY,
