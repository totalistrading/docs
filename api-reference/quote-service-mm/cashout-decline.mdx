...
This endpoint is single-MM scoped and idempotent: declining an already-terminal request is a no-op (`noop: true`).
...
<ResponseField name="data" type="object">
  <Expandable title="data">
    <ResponseField name="status" type="string">`"declined"` (or the request's existing terminal status on a no-op).</ResponseField>
