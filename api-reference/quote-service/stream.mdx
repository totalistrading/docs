...
<RequestExample>
```bash curl
curl -N https://quote-service.totalis.trade/v1/quote-requests/1a6d1f06-9d4f-47cb-994b-3bdfbbef7e40/stream \
...
const eventSource = new EventSource(
  'https://quote-service.totalis.trade/v1/quote-requests/1a6d1f06.../stream',
...
url = 'https://quote-service.totalis.trade/v1/quote-requests/1a6d1f06.../stream'
headers = {
