  ...
  <Expandable title="data">
    ...
    <ResponseField name="quotes" type="array">
      ...
      <Expandable title="Quote object">
        ...
        <ResponseField name="payout_odds" type="number">Payout multiplier on the net stake (`user_cost`).</ResponseField>
        <ResponseField name="user_cost" type="number">Cost to the user in USDC — the net stake, `bet_amount` minus the taker fee.</ResponseField>
