...
<ResponseField name="valid_until" type="string">ISO 8601 timestamp when this bid lapses; a lapsed bid stops being the best bid. Present only when computable; omitted otherwise.</ResponseField>
