  ...
  <Expandable title="data">
    <ResponseField name="quote_request" type="object">
      ...
      <Expandable title="quote_request">
        ...
        <ResponseField name="implied_probability" type="number">Display-only value, commonly `0`. Not computed by the server; a client may set it later in the flow, and it is relayed as-is. Do not price from it.</ResponseField>
