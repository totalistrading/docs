  ...
  <Expandable title="data">
    <ResponseField name="quote_request" type="object">
      ...
      <Expandable title="quote_request">
        ...
        <ResponseField name="implied_probability" type="number">Client-supplied display value, relayed as-is — commonly `0` (the web app does not populate it). Informational only; do not price from it.</ResponseField>
