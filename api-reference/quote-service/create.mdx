...
description: 'Create a new quote request for a parlay.'
---

Create a live [quote request](/guides/glossary#the-noun-stack) for a parlay of 1-5 legs. Every connected market maker receives it immediately and starts quoting.
...
<ParamField body="legs" type="array" required>
  1-5 parlay legs. See [Limits and fees](/guides/limits-and-fees#parlay-construction).
...
<ParamField body="bet_amount" type="number" required>
  Bet amount in USDC, from 1 to 1000.
</ParamField>

<ParamField body="exclude_mm_ids" type="string[]">
  Up to 50 market maker ids whose quotes you do not want, such as the `failed_mm_id` from a commit
  that timed out.
</ParamField>
