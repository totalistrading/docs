...
description: 'Create a new quote request for a bet.'
---

Create a live [quote request](/guides/glossary#the-noun-stack) for a bet of 1-5 legs. Every connected market maker receives it immediately and starts quoting.
...
<ParamField body="legs" type="array" required>
  1-5 legs. See [Limits and fees](/guides/limits-and-fees#bet-construction).
