...
| 404 | `NOT_FOUND` | Position not found or not eligible for cashout. |
| 409 | `CONFLICT` | Position is not active, too close to expiry, or has no counterparty MM assigned yet. |
| 503 | `SERVICE_UNAVAILABLE` | Eligibility/economics read failed; retry. |
