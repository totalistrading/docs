  ...
  <Expandable title="data">
    <ResponseField name="cashout_request" type="object">
      ...
      <Expandable title="cashout_request">
        ...
        <ResponseField name="expires_at" type="string">ISO 8601 TTL horizon of the cashout request (~5 s; the buyback window is intentionally short), distinct from the position expiry.</ResponseField>
