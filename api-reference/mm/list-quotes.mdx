  ...
  <Expandable title="data">
    <ResponseField name="quotes" type="array">
      ...
      <Expandable title="quote">
        ...
        <ResponseField name="payout_odds" type="number">The payout multiplier you quoted. Applies to the net stake (`user_cost`), not the gross bet amount.</ResponseField>
        ...
        <ResponseField name="taker_fee" type="number">Taker fee locked on the quote in USDC (`bet_amount − user_cost`). `0` only if the taker fee rate was zero when the quote was created.</ResponseField>
