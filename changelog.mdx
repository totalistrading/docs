...
{/* Re-date this entry to the production deploy day of the September backend stack before #91 merges. */}
<Update label="3 September 2026" description="Position ids for makers, the fee rate echoed on quotes, and stricter auth errors." tags={["Added", "Changed"]}>
